...
import { bookSchema, type BookData } from "@/lib/validations";
...
export function BookForm({ 
  ...
  const form = useForm<BookData>({
    ...
    defaultValues: {
      ...
      author: book?.author || "",
      genre: book?.genre || "",
      publishedAt: book?.publishedAt || new Date().toISOString().split('T')[0],
      isbn: book?.isbn || "",
      price: book?.price,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <DialogHeader className="pb-4 border-b">
          ...
          <DialogDescription>
            {book ? "Update the book details below." : "Fill in the details to add a new book to your catalog."}
          </DialogDescription>
        </DialogHeader>
          ...
          <Form {...form}>
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-4 gap-6">
                ...
                <div className="col-span-3">
                  ...
                  />
                  {uploading && (
                    <p className="text-sm text-blue-600 mb-1">Uploading...</p>
                  )}
            ...
            <DialogFooter className="border-t pt-4">
              <div className="flex justify-center w-full">
                <Button
                  type="submit"
                  disabled={loading || !form.formState.dirtyFields.title || !form.formState.dirtyFields.author || !form.getValues('title')?.trim() || !form.getValues('author')?.trim()}
                >
