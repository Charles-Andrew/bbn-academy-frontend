import { Calendar, CheckCircle, Clock, Mail, Phone, Star } from "lucide-react";
...
export const metadata = {
  title: "Writing Services & Consultations | BBN Academy",
  description:
    "Professional writing consultations, manuscript reviews, and author coaching to help you bring your story to life. From first-time authors to experienced writers.",
  openGraph: {
    title: "Writing Services & Consultations | BBN Academy",
    description:
      "Professional writing consultations, manuscript reviews, and author coaching to help you bring your story to life. From first-time authors to experienced writers.",
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Whether you're just starting out or need professional feedback
                on your manuscript, there's a service that fits your needs.
              </p>
            </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground">
                  Choose the service that fits your needs and schedule a time
                  that works for you.
                </p>
              </div>
                ...
                <CardContent className="p-6">
                  <div className="flex mb-4">
                    {[1, 2, 3, 4, 5].map((starPosition) => (
                      <Star
                        key={`testimonial-sarah-star-${starPosition}`}
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="flex mb-4">
                    {[1, 2, 3, 4, 5].map((starPosition) => (
                      <Star
                        key={`testimonial-michael-star-${starPosition}`}
                        className="w-4 h-4 fill-primary text-primary"
                      />
                    ))}
                  </div>
                  <p className="text-muted-foreground mb-4">
                    "The manuscript review was incredibly thorough and
                    insightful. The feedback helped me strengthen my story in
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="flex mb-4">
                    {[1, 2, 3, 4, 5].map((starPosition) => (
                      <Star
                        key={`testimonial-jennifer-star-${starPosition}`}
                        className="w-4 h-4 fill-primary text-primary"
                      />
                    ))}
                  </div>
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 opacity-90">
              Let's work together to bring your story to life. Contact me today
              to get started.
            </p>
