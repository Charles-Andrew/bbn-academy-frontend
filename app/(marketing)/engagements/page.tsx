        ...
        <div className="container mx-auto px-4 py-24 md:py-32">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Explore recent workshops, speaking engagements, and consulting
              projects that have made a meaningful impact across organizations
              and communities.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Highlights from recent workshops, speaking engagements, and
              consulting projects
            </p>
          </div>
                              ...
                              <div className="text-center text-primary/60">
                                <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                                  ...
                                  {![
                                    ...
                                    "speaking",
                                    "consultation",
                                  ].includes(engagement.type) && (
                                    <Video className="h-8 w-8 text-primary/80" />
                                  )}
                                </div>
                            ...
                            <div className="space-y-4">
                              ...
                              {engagement.images &&
                                engagement.images.length > 0 && (
                                  <div className="relative h-32 bg-gradient-to-br from-primary/5 to-secondary/5 rounded-lg overflow-hidden">
                                    <Image
                                      src={engagement.images[0]}
                                      alt={engagement.title}
                                      fill
        ...
        <section className="py-16 md:py-24 bg-gradient-to-br from-primary/5 to-secondary/5">
          <div className="container mx-auto px-4">
            <MotionFadeIn className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Different formats for sharing knowledge and driving
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {engagementTypes.map((type) => {
                const typeEngagements = engagements.filter(
                  (e) => e.type === type,
                );
                  ...
                  >
                    <CardContent className="p-8 text-center">
                      ...
                      <p className="text-sm text-muted-foreground mb-4">
                        {typeEngagements.length}{" "}
                        {typeEngagements.length === 1
                          ? "engagement"
                          : "engagements"}{" "}
                        completed
                      </p>
        ...
        <div className="container mx-auto px-4">
          <MotionFadeIn className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Interested in hosting a workshop, scheduling a speaking
              engagement, or exploring consulting opportunities for your
              organization? Let's discuss how we can create meaningful impact
              together.
            </p>
